...
> do tutorial (`gdd/10-narrativa/narrativa-jogada-poc.md`).
>
...
- [ ] Configurar acesso a dados, banco e migrations
...
**Entrega:** o jogador mata o primeiro Mito sem Pacto e ganha Fama.
...
- [ ] Têmpera: multiplicador por arma equipada — sobe com uso ativo, congela offline, reseta na troca
