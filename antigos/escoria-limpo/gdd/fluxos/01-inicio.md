...
>
> Cobre os **passos 1 a 3** de [os 8 passos](../README.md).
...
- [R-JOG-01, R-JOG-02](../sistemas/jogador.md) — aparência e nome escolhidos pelo
  jogador (passo 1)
- [R-JOG-03](../sistemas/jogador.md) — nasce em A Ressaca (passo 2)
- [R-JOG-04](../sistemas/jogador.md) — recebido pelo Guia (passo 3)
