---
tags: [estudo, arquitetura, pvp, pos-poc]
fatia: 7, pos-poc
---
...
O ponto central de [[02-ownership-e-concorrencia]], repetido porque é aqui que ele
se paga:
...
argumento definitivo do WebSocket em [[04-rede-http-e-websocket]]: o servidor
inicia a conversa.
...
cliente, seria falsificável — e é por isso que [[01-modelo-mental]] insiste que
