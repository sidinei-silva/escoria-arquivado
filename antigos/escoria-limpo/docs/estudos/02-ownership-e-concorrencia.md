...
perguntas do [AGENTS.md](../../AGENTS.md) existem para isso.
...
boot ([01-modelo-mental](01-modelo-mental.md)).
...
Ver [06-zonas-presenca-e-pvp](06-zonas-presenca-e-pvp.md).
...
Repetidas do [AGENTS.md](../../AGENTS.md) porque é aqui que valem:
