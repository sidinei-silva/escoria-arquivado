...
dono dele. Ver [05-persistencia](05-persistencia.md).

## Os tipos, em forma

> Ilustração de forma. Não copiar. Ver o aviso no [README](README.md).
...
| Concorrência | nenhuma — imutável após boot | ver [02-ownership-e-concorrencia](02-ownership-e-concorrencia.md) |
...
Ver [README](README.md) para o que é estudo e o que vira ADR.
