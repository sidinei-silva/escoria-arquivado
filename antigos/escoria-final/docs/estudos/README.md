...
e eu quebrei o [[../AGENTS|AGENTS.md]].

## Mapa: qual estudo em qual fatia

| Fatia | O que entrega | Estudo |
|---|---|---|
| 0 — Fundação | servidor sobe, carrega conteúdo | [[01-modelo-mental]] |
| 1 — Personagem | criar personagem, ver A Ressaca | [[01-modelo-mental]], [[04-rede-http-e-websocket]] |
| 2 — Primeira arma | equipar, loadout muda | — |
| 3 — Primeiro combate | matar o primeiro Mito, Fama, Têmpera simples | [[02-ownership-e-concorrencia]], [[03-tempo-e-atividades]] |
| 4 — Coleta | coletar em loop, inventário, banco entra | [[03-tempo-e-atividades]], [[05-persistencia]] |
| 5 — Bigorna | viajar, refinar, craftar | [[03-tempo-e-atividades]] |
| 6 — Outro portador | encontro com o NPC-Portador | — |
| 7 — Zonas T2 | viajar e agir em tier 2 | [[06-zonas-presenca-e-pvp]] |
| 8 — Segunda arma | combate T2, fila de habilidades, Têmpera completa | [[02-ownership-e-concorrencia]] |
| 9 — Litania e Saída | ver a Litania, atravessar A Encruzilhada | [[05-persistencia]] |
| pós-PoC | multiplayer, gank, PvP | [[06-zonas-presenca-e-pvp]] |
...
1. [[01-modelo-mental]] — command, state, event. O que o servidor é.
2. [[02-ownership-e-concorrencia]] — quem é dono do estado. Mutex, channel, actor.
3. [[03-tempo-e-atividades]] — atividade não é instantânea. Game loop e tick.
4. [[04-rede-http-e-websocket]] — qual porta serve o quê, e por quê.
5. [[05-persistencia]] — o banco não dirige o game loop.
6. [[06-zonas-presenca-e-pvp]] — o desenho que o jogo final quer.
...
sobreviveu é o que passa no teste do [[../AGENTS|AGENTS.md]]: consigo explicar
amanhã, sem olhar.
