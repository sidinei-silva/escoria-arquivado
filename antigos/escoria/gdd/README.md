...
→ [[sistemas/jogador]] · [[sistemas/zonas]]
→ diálogos: `dialog_passo1_abertura`, `dialog_passo1_reacao`
→ detalhe: [[fluxos/01-inicio]]
...
→ [[sistemas/zonas]] · `sistemas/inventario` *(a migrar)*
...
- [[sistemas/jogador]] — `R-JOG-01` a `R-JOG-05`
- [[sistemas/zonas]] — `R-ZON-01` a `R-ZON-03`

Todo o resto ainda está no Notion. Isso é esperado.

## Prosa longa

- [[livro-de-imersao]] — o mundo em prosa contínua, 7 livros. Não é cânone
