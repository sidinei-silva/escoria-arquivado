...
- **Cada request roda na própria goroutine.** O `net/http` faz isso sozinho. Ou
  ...
  [02-ownership-e-concorrencia](02-ownership-e-concorrencia.md) existir.
...
Repare que é o mesmo princípio de [02-ownership-e-concorrencia](02-ownership-e-concorrencia.md) em escala
