...
Ver [[docs/estudos/02-ownership-e-concorrencia]].

## Ideias vindas de outros jogos

Vão para [[IDEIAS]]. **Não** para o GDD, **não** para o backlog.
...
fatia funcionar, nunca antes — é o passo 6.3 da [[docs/RECEITA|receita]]. IA pode revisar
