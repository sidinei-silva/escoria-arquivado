...
> leia só isto.
>
> Regras de uso de IA: [AGENTS.md](../../AGENTS.md).
...
> Conversa com [loadout](sistemas/loadout.md) e [fama](sistemas/fama.md).
...
[AGENTS.md](../../AGENTS.md) valem antes de escrever.
...
Todas vivem no mesmo arquivo, em ordem. **ADR nunca é editada.** Mudou de ideia? ADR nova, com `Status: substitui
...
specs/
├── S-001-*/           ativa (uma por vez)
└── arquivo/           mortas, nunca mais lidas

docs/
├── RECEITA.md         este arquivo
├── BACKLOG.md         as 10 fatias
├── adr/decisoes.md    decisões tomadas. Append-only, nunca editada.
...
| ADR | `ADR-<NNN>` em `docs/adr/decisoes.md` | `ADR-011` |
